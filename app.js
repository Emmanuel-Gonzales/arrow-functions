...
// When "this" is invoked in a constructor it refers to the properties in the object
//
// 2. What is "this" when joe.scopeArrow() is invoked?
// However in an arrow funtion "this" refers to the entire window and the global properties, instead of the speciffic object.
//
// 3. Explain why "this" is different when an arrow function is used.
// I belive this is the case because an arrow function doesn't require brackets. Without the brackets, the code isn't limited to just that function and is insted global. The curly brackets act as a container.
//
